        ...
        <div className="container-padding max-w-5xl mx-auto">
          ...
          <div className="mt-16 md:mt-20 text-center max-w-3xl mx-auto p-8 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700">
            ...
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              Fluxeco zet zich in voor een duurzame energietoekomst voor Vlaanderen. Onze prijsmodellen zijn ontworpen om billijk te zijn, echte waarde te bieden aan zonneproducenten en bedrijven een betrouwbare manier te bieden om groene energie aan te kopen. Wij geloven in duidelijke communicatie en ongecompliceerde partnerschappen.
            </p>
